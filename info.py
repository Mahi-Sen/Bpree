...
BOT_TOKEN = environ.get('BOT_TOKEN', "6806973515:AAENRDiMErvAITe77y7H2oQCmue8aimnRaA")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002081230046').split()] #Channel id for auto indexing ( make sure bot is admin )
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002061544743') #Channel / Group Id for force sub ( make sure bot is admin )
...
DATABASE_NAME = environ.get('DATABASE_NAME', "werty")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002146512336')) #Log channel id ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002081230046'))
